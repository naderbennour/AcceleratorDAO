...
import AcceleratorDAO from './abis/AcceleratorDAO.json'
...
const loadWeb3 = async () => {
  try {
    ...
    const networkData = AcceleratorDAO.networks[networkId]
    ...
    if (networkData) {
      ...
      window.alert('AcceleratorDAO contract not deployed to detected network.')
    }
    return true
  } catch (error) {
